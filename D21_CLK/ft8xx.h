...
#define REG_FLASH_SIZE          (0x302000+0x7024)
#endif
...
#define BITMAP_LAYOUT(f,s,h) (DL_BITMAP_LAYOUT | (((unsigned long )(f) & 0x0000001F)<<19) | (((unsigned long)(s) & 0x000003FF)<<9) | ((unsigned long )(h) & 0x000001FF) )
#define BITMAP_SIZE(f,wx,wy,w,h) (DL_BITMAP_SIZE | (((unsigned long)(f) & 0x00000001)<<20) | (((unsigned long)(wx) & 0x00000001)<<19) | (((unsigned long)(wy) & 0x00000001) << 18) | (((unsigned long)(w) & 0x000001FF) << 9) | ((unsigned long)(h) & 0x000001FF)) 
...
#define VERTEX_FORMAT(m)	(DL_VERTEX_FORMAT | ((unsigned long)m & 0x00000007))

#define USE_CELL(m)	(DL_CELL | ((unsigned long)m & 0x00000007))
...
#define COLOR_ALPHA( alpha ) (DL_COLOR_A | ((unsigned long)alpha & 0x000000FF) )
#define BLEND_FUNC( src,dst ) (DL_BLEND_FUNC | (((unsigned long)src & 0x00000007)<<3) | ((unsigned long)dst&0x00000007) )


#define LCD_480x272 0
#define LCD_800x480 1
...
bool HostMemWrite_RomBurst( unsigned long adr, unsigned char *ptr,unsigned long size );
